...
#ifndef _GxEPD2_290_T94x_H_
#define _GxEPD2_290_T94x_H_

#include "../GxEPD2_EPD.h"

#include <vector>

class GxEPD2_290_T94x : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    // constructor
    GxEPD2_290_T94x(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
  ...
  private:
    ...
    std::vector<uint8_t> currentScreen; 
    std::vector<uint8_t> previousScreen; 
    uint8_t x11{};
    uint8_t y11{};
    uint8_t x22{};
    uint8_t y22{};
    uint8_t xx{};
    uint8_t yy{};
    void writeScreen(uint8_t value);
};
